...
async function loadTrekDetails(slug) {
  try {
    ...
    if (cachedRouteData) {
      ...
      if (cached.kind === "tour-category" || cached.kind === "trek-category") {
    ...
    : packageData.originalPriceINR;
       ...
       <div
                        ...
                        <div class="relative overflow-hidden">
                            <img src="${packageData.thumbnail ? packageData.thumbnail : "./images/affortable package.webp"}" width="420" height="260" alt="Nun Kun Ladakh" loading="lazy" decoding="async"
                                decoding="async"
                        ...
                        <div class="grid grid-cols-2 gap-2 p-1.5 pb-0">
                            <div
    ...
    : singlepackage.originalPriceINR;
                const card=`
                    ...
                    <div
                        ...
                        <img src="${singlepackage.gallery[0].url}" width="420" height="520" loading="lazy" decoding="async" alt="Goechala Trek"
